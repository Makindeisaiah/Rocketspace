            ...
            {activeTab === 'automate' ? (
                ...
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-14 items-center">
                  ...
                  <div className="lg:col-span-6 flex flex-col items-start text-left">
                    ...
                    <motion.button 
                      ...
                      whileTap={{ scale: 0.97 }}
                      className="bg-[#F1F3F5] hover:bg-[#E5E8EB] text-neutral-800 font-semibold px-5 py-2.5 rounded-xl text-sm inline-flex items-center gap-1.5 transition-colors cursor-pointer"
                    >
                      <span>Notify Me</span>
              ...
              >
                ...
                <button
                  ...
                  className="text-xs font-semibold text-[#1F6363] hover:underline cursor-pointer"
                >
